      ...
      <div class="row">
        <div style="margin-top: 40px" class="col-md-3">
          ...
          <div   class="list-group ">
            <router-link    class="list-group-item list-group-item-success carditem" :to="{name:'callusslink'}" >
              联系我们
            </router-link>
  ...
  export default {
    ...
    data () {
      return {
        sliders:[
          {
            img:'../../static/lunbo01.jpg'
          },
          {
            img:'../../static/lunbo02.jpg'
          },
          {
            img:'../../static/lunbo03.jpg'
          },
          {
            img:'../../static/lunbo04.jpg'
          },
          {
            img:'../../static/lunbo05.jpg'
          }
        ],
        currentIndex:1,
        distance:-1200,
      ...
      animate(des, direc, speed) {
        ...
        this.temp = window.setInterval(() => {
          if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
            ...
            window.clearInterval(this.temp)
            this.distance = des
            if (des < -6000) this.distance = -1200
            if (des > -1200) this.distance = -6000
          }
        }, 20)
      },
      jump(index) {
